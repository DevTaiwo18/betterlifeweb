...
<body>
    ...
    @section('section')
        <section class="bg-white shadow-lg sec">
            ...
            <main class="px-2 px-sm-1">
                <h1 class="my-5 convert">Bank USSD's</h1>
                <div class="container">
                    <div class="row" style="margin-top: -25px;">
                        <div class="col">
                            <div>
                                <p>Quick Bank Lock
                                    If you lose your phone, quick lock money in your bank account:
                                    Dial the code from any line, you will be asked to enter the phone number you
                                    want to deactivate, and that settles it.</p>
                            </div>
                        </div>
                        <div class="col  text-center" style="margin-top: -p;">
                            <p>USSD <br> BANK <br> ACCOUNT</p>
                        </div>

                        <div class="col">
                            <p class="regulation">REGULATION USSD</p>
                        </div>
                    </div>

                    <table class="mt-4">
                        <tr class="d-flex align-items-center justify-between" style="gap: 8rem;">
                            <td class="d-flex align-items-center gap-5">
                                <p>Access Bank</p>
                                <p>*901*911# <button><i class="fa fa-copy"></i></button></p>
                            </td>
                            <td class="d-flex align-items-center gap-5">
                                <p>*901# <button><i class="fa fa-copy"></i></button></p>
                            </td>
                            <td class="d-flex align-items-center gap-5">
                                <p>Check Your BVN</p>
                                <p>*565*0# <button><i class="fa fa-copy"></i></button></p>
                            </td>
                        </tr>
                    </table>
                </div>
