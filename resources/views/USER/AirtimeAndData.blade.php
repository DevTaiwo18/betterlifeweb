        ...
        <section class="bg-white shadow-lg sec">
            <main>
                <div class="container d-flex gap-4">
                    <button class="btn airDat mr-5" onclick="showAirtime()" type="button">Buy Airtime</button>
                    <button class="btn airDat" onclick="showData()" type="button">Buy Data</button>
                </div>
                <div class="container">
                    <div class="row">
                        <div class="col px-2 px-sm-10">
                            <div id="showAirtime" class="pa-5 rounded-lg dashform">
                                <form class="for">
                                    ...
                                    <div class="form-group my-2">
                                        <label class="my-2 d-block" for="">Phone Number</label>
                            ...
                            <div id="showData" class="pa-5 rounded-lg dashform" style="display:none;">
                                <form class="for">
                                    <div class="form-group my-5">
